...
func handleCreate(ctxArg interface{}, key string,
	...
	effectiveActivate := effectiveActivateCurrentProfile(config, ctx)
...
func effectiveActivateCurrentProfile(config types.AppInstanceConfig, ctx *zedmanagerContext) bool {
